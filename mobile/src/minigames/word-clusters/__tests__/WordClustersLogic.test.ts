import { generatePuzzle, checkGroup, validateSolution, WordClustersPuzzle, GroupDefinition } from '../WordClustersLogic';
...
describe('validateSolution', () => {
  const puzzle: WordClustersPuzzle = {
    words: [
      'SAP', 'DEW', 'HONEY', 'WAX',
