import { generatePuzzle, checkGroup, MAX_MISTAKES } from '../../word-groups/WordGroupsLogic';
import type { WordGroupsPuzzle } from '../../word-groups/WordGroupsLogic';
import { balancedSplit } from '../WordGroupsCoopGame';

describe('WordGroupsCoop: balancedSplit', () => {
  let puzzle: WordGroupsPuzzle;
...
describe('WordGroupsCoop: submission with correct group', () => {
...
describe('WordGroupsCoop: submission with wrong group increments mistakes', () => {
...
describe('WordGroupsCoop: win detection at 4 solved groups', () => {
...
describe('WordGroupsCoop: loss detection at MAX_MISTAKES', () => {
