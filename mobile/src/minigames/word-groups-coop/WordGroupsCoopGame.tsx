 ...
 */
export function balancedSplit(puzzle: WordGroupsPuzzle): BalancedSplit {
  const top: string[] = [];
  const bottom: string[] = [];
...
export default function WordGroupsCoopGame(props: MinigamePlayProps) {
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerText}>Word Groups Co-op</Text>
